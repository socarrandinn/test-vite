...
export const CajaInfo = () => {
  ...
  return (
    <div className="flex flex-col gap-y-3">
      ...
      <div className='flex justify-between gap-x-2 items-center bg-azul-medio mt-5 px-1.5 py-2 rounded-full text-xs font-bold bg-opacity-80 mr-auto cursor-pointer'>
